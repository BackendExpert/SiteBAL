    ...
    const OurService = [
        {
            ...
            technogloy: 'HTML, CSS, JavaScript, React, NodeJS',
            Logo: ''
        },
        {
            id: 2,
            ...
            technogloy: 'Microsoft Azure, AWS, Google Cloud, Cisco, Fortinet, VMware',
            Logo: ''
        },

        {
            ...
            technogloy: 'Adobe XD, Figma, Sketch, InVision, Axure',
            Logo: ''
        },
...

        {
            ...
            technogloy: ' AWS, Microsoft Azure, Google Cloud,',
            Logo: ''
        },
    ]
  return (
